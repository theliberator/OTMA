...
/**
 * @classdesc Extends jQuery and can be used to
 * generate some fields of colors as a color picker.
 * To define the colors which are used, the property
 * colors can be overridden by defining it as a part of
 * the props list parameter. 
 *
 * @param {object} props Properties for color picker.
 * @returns {object} this (??).
*/
