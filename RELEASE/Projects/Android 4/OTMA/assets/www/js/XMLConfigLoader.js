 ...
 */
 ...
 /**
 * @classdesc   This class is responsible for parsing XML configuration files (mainly
...
/**
 * Used to access XMLConfigLoader.
 *
 * @returns {XMLConfigLoader} The singleton instance.
 */
...
/**
* @property {object} otma Contains global configuration information.
*/
...
/**
* @property {object} map Contains map specific configuration information.
*/
...
/**
* @property {object} Values Contains a dictionary entry for identifiying 
* XML text nodes.
*/
...
/**
 * Resets the XMLConfigLoader (otma and map information).
 */
...
/**
 * Loads the OTMA-XML-configuration file.
 *
...
/**
 * Loads the map layout related information from an XML file.
 *
...
/**
 * Loads event information from an XML file.
 *
 * @param {string} path Path to the XML file.
 * @param {function} callback Function that will be called after the load has finished
 */
