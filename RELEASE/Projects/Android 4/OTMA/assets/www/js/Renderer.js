 ...
 */
 ...
 /**
 * @classdesc This module cares about all relevant stuff to display the game in the three canvas layers.
...
/**
 * Used to access Renderer.
 *
 * @returns {Renderer} The singleton instance.
 */
...
/**
 * Set singleton instance of Renderer to null, to trigger
 ...
 * @param {string} font The font used for measurement.
 ...
 * @param {boolean} centered True if text should be centered, otherwise false.
 ...
 * Draws the screen.
 *
 * @param {boolean} forced True if the draw should be forced, otherwise false.
 */
 ...
 *
 * @param {object} ctx Context.
 * @param {object} layer The tile is on.
 */
 ...
 * Draws a character
 *
 * @param {object} r_ctx Context.
 * @param {object} npc The NPC to draw.
 */
 ...
 *
 * @param {object} r_ctx Context.
 * @param {number} bg_x Unknown.
 * @param {number} bg_y Unknown.
 * @param {number} npc_x X coordinate of the position of the NPC.
 * @param {number} npc_y Y coordinate of the position of the NPC.
...
/**
 * Draw a dialog. Currently unused.
 */
